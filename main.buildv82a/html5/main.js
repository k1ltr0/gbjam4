...
c_Time.m_processFrozen=function(){
	push_err();
	err_info="/Users/ricardo/MonkeyXPro82a/modules_ext/lp2/time/time.monkey<19>";
	if(c_Time.m__aux_time>=c_Time.m__frozen_time){
		err_info="/Users/ricardo/MonkeyXPro82a/modules_ext/lp2/time/time.monkey<20>";
		c_Time.m__frozen=false;
		err_info="/Users/ricardo/MonkeyXPro82a/modules_ext/lp2/time/time.monkey<21>";
		c_Time.m__aux_time=0;
	}
	...
	err_info="/Users/ricardo/MonkeyXPro82a/modules_ext/lp2/time/time.monkey<27>";
	c_Time.m__delta=1;
	err_info="/Users/ricardo/MonkeyXPro82a/modules_ext/lp2/time/time.monkey<28>";
	c_Time.m__delta_secs=0.001;
	pop_err();
}
c_Time.m_OnUpdate=function(){
	push_err();
	err_info="/Users/ricardo/MonkeyXPro82a/modules_ext/lp2/time/time.monkey<36>";
	if(c_Time.m__frozen){
	...
	err_info="/Users/ricardo/MonkeyXPro82a/modules_ext/lp2/time/time.monkey<43>";
	c_Time.m__time_last_update=bb_app_Millisecs();
	err_info="/Users/ricardo/MonkeyXPro82a/modules_ext/lp2/time/time.monkey<46>";
...
c_Time.m_DeltaSecs=function(){
	push_err();
	err_info="/Users/ricardo/MonkeyXPro82a/modules_ext/lp2/time/time.monkey<63>";
	pop_err();
	return c_Time.m__delta_secs;
}
c_Time.m_Freeze=function(t_millis){
	push_err();
	err_info="/Users/ricardo/MonkeyXPro82a/modules_ext/lp2/time/time.monkey<50>";
	if(!c_Time.m__frozen){
		err_info="/Users/ricardo/MonkeyXPro82a/modules_ext/lp2/time/time.monkey<51>";
...
c_GamePlaySpace.prototype.p_AddElements=function(t_objects){
	...
	while(t_.p_HasNext()){
		...
		err_info="/Users/ricardo/git_loadingplay/gbjam4/src/spaces/gameplay.monkey<49>";
		if(String(dbg_object(t_o).m_gid)=="200"){
			...
			if(String(dbg_object(t_o).m_gid)=="4097" || String(dbg_object(t_o).m_gid)=="4098" || String(dbg_object(t_o).m_gid)=="4099"){
				err_info="/Users/ricardo/git_loadingplay/gbjam4/src/spaces/gameplay.monkey<55>";
				var t_enemy=c_Enemy.m_new.call(new c_Enemy,(t_o),String(dbg_object(t_o).m_gid));
				...
				if(String(dbg_object(t_o).m_gid)=="4100" || String(dbg_object(t_o).m_gid)=="4101"){
					...
					var t_enemy2=c_EnemyTurret.m_new.call(new c_EnemyTurret,(t_o),String(dbg_object(t_o).m_gid));
					err_info="/Users/ricardo/git_loadingplay/gbjam4/src/spaces/gameplay.monkey<61>";
					dbg_object(t_enemy2).m_player_position=dbg_object(dbg_object(this).m_player).m_position;
					err_info="/Users/ricardo/git_loadingplay/gbjam4/src/spaces/gameplay.monkey<63>";
					this.p_AddChild2(t_enemy2);
				}
			}
		}
	}
...
c_GamePlaySpace.prototype.p_Create=function(){
	push_err();
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/spaces/gameplay.monkey<18>";
	dbg_object(this).m_world=c_World.m_new.call(new c_World);
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/spaces/gameplay.monkey<19>";
	...
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/spaces/gameplay.monkey<24>";
	...
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/spaces/gameplay.monkey<36>";
	...
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/spaces/gameplay.monkey<44>";
...
c_World.prototype.p_GetCollisionsLayer=function(){
	push_err();
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/sprites/world.monkey<37>";
...
c_Player.prototype.p_Create=function(){
	push_err();
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/sprites/player.monkey<23>";
	dbg_object(this).m_position=c_Rectangle.m_new3.call(new c_Rectangle,30.0,60.0,23.0,8.0);
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/sprites/player.monkey<24>";
	dbg_object(this).m_box=c_Rectangle.m_new3.call(new c_Rectangle,0.0,0.0,10.0,4.0);
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/sprites/player.monkey<27>";
	...
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/sprites/player.monkey<29>";
	dbg_object(this).m_sprite.p_PlaySequence("fly",83,true);
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/sprites/player.monkey<32>";
	...
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/sprites/player.monkey<40>";
	dbg_object(this).m_cannon.p_AddSprite("bullet_level_0.png");
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/sprites/player.monkey<41>";
	...
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/sprites/player.monkey<43>";
...
c_Player.m_new=function(){
	push_err();
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/sprites/player.monkey<18>";
	this.p_Create();
	pop_err();
	return this;
}
...
c_Player.prototype.p_Die=function(){
	...
	c_CollisionEngine.m_Instance2().p_Destroy2(this);
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/sprites/player.monkey<98>";
	dbg_object(this).m_visible=false;
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/sprites/player.monkey<100>";
...
c_Player.prototype.p_OnCollide=function(t_name){
	...
	if(t_name=="powerup"){
		...
		err_info="/Users/ricardo/git_loadingplay/gbjam4/src/sprites/player.monkey<83>";
		if(t_name=="enemy" || t_name=="enemy_bullet"){
			...
			if(dbg_object(dbg_object(this).m_cannon).m_level==0){
				...
				err_info="/Users/ricardo/git_loadingplay/gbjam4/src/sprites/player.monkey<88>";
				dbg_object(this).m_cannon.p_LevelDown();
				err_info="/Users/ricardo/git_loadingplay/gbjam4/src/sprites/player.monkey<89>";
				c_Time.m_Freeze(200);
			}
		}else{
			err_info="/Users/ricardo/git_loadingplay/gbjam4/src/sprites/player.monkey<91>";
			if(t_name=="wall"){
				err_info="/Users/ricardo/git_loadingplay/gbjam4/src/sprites/player.monkey<92>";
				this.p_Die();
			}
		}
	}
...
c_IntStack.prototype=extend_class(c_Stack10);
...
c_SpaceShooterControl.m_new=function(t_target){
	push_err();
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/components/space_shooter_control.monkey<9>";
...
c_SpaceShooterControl.prototype.p_Update=function(){
	push_err();
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/components/space_shooter_control.monkey<13>";
	dbg_object(this).m_shot=false;
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/components/space_shooter_control.monkey<15>";
	if(((bb_input_KeyDown(38))!=0) || ((bb_input_KeyDown(87))!=0)){
		...
		dbg_object(this).m_target.p_Y(t_.p_Y2()-100.0*c_Time.m_DeltaSecs());
	}
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/components/space_shooter_control.monkey<19>";
	if(((bb_input_KeyDown(40))!=0) || ((bb_input_KeyDown(83))!=0)){
		...
		dbg_object(this).m_target.p_Y(t_2.p_Y2()+100.0*c_Time.m_DeltaSecs());
	}
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/components/space_shooter_control.monkey<23>";
	if(((bb_input_KeyDown(37))!=0) || ((bb_input_KeyDown(65))!=0)){
		...
		dbg_object(this).m_target.p_X(t_3.p_X2()-100.0*c_Time.m_DeltaSecs());
	}
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/components/space_shooter_control.monkey<27>";
	if(((bb_input_KeyDown(39))!=0) || ((bb_input_KeyDown(68))!=0)){
		...
		dbg_object(this).m_target.p_X(t_4.p_X2()+100.0*c_Time.m_DeltaSecs());
	}
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/components/space_shooter_control.monkey<31>";
...
c_SpaceShooterControl.prototype.p_Shot=function(){
	push_err();
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/components/space_shooter_control.monkey<38>";
	pop_err();
...
c_SpaceShooterCannon.prototype.p_Create=function(){
	...
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/components/space_shooter_cannon.monkey<55>";
...
c_SpaceShooterCannon.m_new=function(t_target){
	...
	dbg_object(this).m_target=t_target;
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/components/space_shooter_cannon.monkey<49>";
	this.p_Create();
	pop_err();
	return this;
}
...
c_SpaceShooterCannon.prototype.p_Offset=function(){
	push_err();
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/components/space_shooter_cannon.monkey<98>";
	pop_err();
...
c_SpaceShooterCannon.prototype.p_LevelDown=function(){
	...
	dbg_object(this).m_level-=1;
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/components/space_shooter_cannon.monkey<120>";
...
c_SpaceShooterCannon.prototype.p_Update=function(){
	...
	while(t_.p_HasNext()){
		...
		err_info="/Users/ricardo/git_loadingplay/gbjam4/src/components/space_shooter_cannon.monkey<61>";
		var t_2=dbg_object(t_b).m_Position;
		dbg_object(t_b).m_Position.p_X(t_2.p_X2()+(dbg_object(this).m_speed)*c_Time.m_DeltaSecs());
		err_info="/Users/ricardo/git_loadingplay/gbjam4/src/components/space_shooter_cannon.monkey<62>";
		...
		if(dbg_object(t_b).m_max_live_time*(1+dbg_object(this).m_level)<=dbg_object(t_b).m_current_live_time){
			...
			t_b.p_Destroy();
			err_info="/Users/ricardo/git_loadingplay/gbjam4/src/components/space_shooter_cannon.monkey<66>";
	...
	while(t_3.p_HasNext()){
		...
		err_info="/Users/ricardo/git_loadingplay/gbjam4/src/components/space_shooter_cannon.monkey<73>";
		dbg_object(this).m_bullets.p_RemoveEach(t_db);
	}
	...
	if((bb_input_KeyHit(69))!=0){
		err_info="/Users/ricardo/git_loadingplay/gbjam4/src/components/space_shooter_cannon.monkey<84>";
		this.p_LevelDown();
	}
	pop_err();
}
c_SpaceShooterCannon.prototype.p_Shot=function(){
	...
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/components/space_shooter_cannon.monkey<108>";
...
c_SpaceShooterCannon.prototype.p_Render=function(){
	...
	while(t_.p_HasNext()){
		...
		if(dbg_object(t_b).m_visible){
			err_info="/Users/ricardo/git_loadingplay/gbjam4/src/components/space_shooter_cannon.monkey<92>";
			t_b.p_Render();
		}
	}
	pop_err();
...
c_Bullet.prototype.p_Destroy=function(){
	push_err();
...
c_Bullet.m_new=function(t_img,t_position){
	push_err();
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/components/space_shooter_cannon.monkey<11>";
	c_lpImage.m_new2.call(this,t_img,t_position);
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/components/space_shooter_cannon.monkey<13>";
	c_CollisionEngine.m_Instance2().p_AddBody(this);
	pop_err();
	return this;
}
c_Bullet.m_new2=function(){
	push_err();
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/components/space_shooter_cannon.monkey<4>";
	c_lpImage.m_new6.call(this);
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/components/space_shooter_cannon.monkey<4>";
	pop_err();
	return this;
...
c_Bullet.prototype.p_GetBox=function(){
	push_err();
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/components/space_shooter_cannon.monkey<17>";
	pop_err();
	return dbg_object(this).m_Position;
}
c_Bullet.prototype.p_OnCollide=function(t_name){
	push_err();
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/components/space_shooter_cannon.monkey<20>";
...
c_Bullet.prototype.p_GetName=function(){
	push_err();
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/components/space_shooter_cannon.monkey<25>";
	pop_err();
...
c_CollisionEngine.prototype.p_Create=function(){
	...
	dbg_object(this).m_objects=c_Stack11.m_new.call(new c_Stack11);
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/components/collision_engine.monkey<26>";
	dbg_object(this).m_static_objects=c_Stack11.m_new.call(new c_Stack11);
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/components/collision_engine.monkey<27>";
	dbg_object(this).m_delegates=c_Stack12.m_new.call(new c_Stack12);
	pop_err();
}
...
c_CollisionEngine.m_Instance2=function(){
	push_err();
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/components/collision_engine.monkey<79>";
	...
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/components/collision_engine.monkey<83>";
	pop_err();
...
c_CollisionEngine.prototype.p_AddBody=function(t_body){
	...
	dbg_object(this).m_objects.p_Push28(t_body);
	pop_err();
}
c_CollisionEngine.prototype.p_AddStaticBody=function(t_body){
	...
	dbg_object(this).m_static_objects.p_Push28(t_body);
	pop_err();
	return 0;
}
c_CollisionEngine.prototype.p_RegisterDelegate=function(t_collision_engine){
	...
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/components/collision_engine.monkey<75>";
	dbg_object(this).m_delegates.p_Push31(t_collision_engine);
	pop_err();
}
c_CollisionEngine.prototype.p_Destroy2=function(t_element){
	push_err();
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/components/collision_engine.monkey<67>";
	dbg_object(this).m_objects.p_RemoveEach2(t_element);
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/components/collision_engine.monkey<68>";
	dbg_object(this).m_static_objects.p_RemoveEach2(t_element);
	pop_err();
}
...
c_Stack11.prototype.p_Equals3=function(t_lhs,t_rhs){
	push_err();
...
c_Stack11.prototype.p_RemoveEach2=function(t_value){
	push_err();
...
c_PowerUp.prototype.p_Destroy=function(){
	push_err();
...
c_Enemy.prototype.p_InitAI=function(){
	push_err();
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/sprites/enemy.monkey<101>";
	var t_1=dbg_object(this).m_type;
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/sprites/enemy.monkey<102>";
	if(t_1=="4097"){
		err_info="/Users/ricardo/git_loadingplay/gbjam4/src/sprites/enemy.monkey<103>";
		dbg_object(this).m_ai=(c_EnemyAAI.m_new.call(new c_EnemyAAI,this));
	}else{
		err_info="/Users/ricardo/git_loadingplay/gbjam4/src/sprites/enemy.monkey<104>";
		if(t_1=="4098"){
			err_info="/Users/ricardo/git_loadingplay/gbjam4/src/sprites/enemy.monkey<105>";
			dbg_object(this).m_ai=(c_EnemyBAI.m_new.call(new c_EnemyBAI,this));
		}else{
			...
			if(t_1=="4099"){
				...
				dbg_object(this).m_ai=(c_EnemyCAI.m_new.call(new c_EnemyCAI,this));
			}
		}
	}
	pop_err();
...
c_Enemy.prototype.p_Create=function(){
	...
	dbg_object(this).m_animated_sprite=c_AnimatedSprite.m_new.call(new c_AnimatedSprite,"enemies.png",c_Vec2.m_new.call(new c_Vec2,0.0,0.0),9.0,9.0,3,0.0);
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/sprites/enemy.monkey<85>";
...
c_Enemy.prototype.p_Update=function(){
	...
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/sprites/enemy.monkey<116>";
	dbg_object(this).m_cannon.p_Update();
	pop_err();
}
c_Enemy.prototype.p_Render=function(){
	push_err();
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/sprites/enemy.monkey<120>";
	if(!dbg_object(this).m_visible){
		pop_err();
		return;
	}
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/sprites/enemy.monkey<122>";
	bb_graphics_PushMatrix();
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/sprites/enemy.monkey<123>";
	bb_graphics_Translate(dbg_object(this).m_position.p_X2(),dbg_object(this).m_position.p_Y2());
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/sprites/enemy.monkey<124>";
...
c_Enemy.prototype.p_OnCollide=function(t_name){
	...
	if(t_name=="player" || t_name=="player_bullet"){
		err_info="/Users/ricardo/git_loadingplay/gbjam4/src/sprites/enemy.monkey<137>";
		dbg_object(this).m_visible=false;
		err_info="/Users/ricardo/git_loadingplay/gbjam4/src/sprites/enemy.monkey<138>";
		dbg_object(this).m_cannon.p_Destroy();
...
c_Enemy.prototype.p_GetName=function(){
	push_err();
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/sprites/enemy.monkey<144>";
	pop_err();
	return "enemy";
}
...
c_EnemyCannon.prototype.p_Destroy=function(){
	push_err();
...
c_EnemyBullet.prototype.p_Destroy=function(){
	push_err();
...
c_EnemyAI.prototype.p_Create=function(){
	push_err();
	pop_err();
}
c_EnemyAI.m_new=function(t_parent){
	push_err();
...
c_EnemyAI.prototype.p_Render=function(){
	push_err();
	pop_err();
}
function c_EnemyAAI(){
...
c_EnemyAAI.prototype=extend_class(c_EnemyAI);
c_EnemyAAI.m_new=function(t_parent){
	push_err();
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/sprites/enemy.monkey<42>";
	c_EnemyAI.m_new.call(this,t_parent);
	pop_err();
	return this;
}
c_EnemyAAI.m_new2=function(){
	push_err();
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/sprites/enemy.monkey<40>";
	c_EnemyAI.m_new2.call(this);
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/sprites/enemy.monkey<40>";
	pop_err();
	return this;
}
...
c_EnemyBAI.prototype=extend_class(c_EnemyAI);
c_EnemyBAI.m_new=function(t_parent){
	push_err();
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/sprites/enemy.monkey<48>";
	c_EnemyAI.m_new.call(this,t_parent);
	pop_err();
	return this;
}
c_EnemyBAI.m_new2=function(){
	push_err();
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/sprites/enemy.monkey<46>";
	c_EnemyAI.m_new2.call(this);
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/sprites/enemy.monkey<46>";
	pop_err();
	return this;
...
c_EnemyCAI.prototype=extend_class(c_EnemyAI);
c_EnemyCAI.m_new=function(t_parent){
	push_err();
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/sprites/enemy.monkey<54>";
	c_EnemyAI.m_new.call(this,t_parent);
	pop_err();
	return this;
}
c_EnemyCAI.m_new2=function(){
	push_err();
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/sprites/enemy.monkey<52>";
	c_EnemyAI.m_new2.call(this);
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/sprites/enemy.monkey<52>";
	pop_err();
	return this;
...
c_EnemyTurret.m_new=function(t_position,t_gid){
	push_err();
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/sprites/enemy_turret.monkey<15>";
...
c_EnemyTurret.m_new2=function(){
	push_err();
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/sprites/enemy_turret.monkey<12>";
	c_Enemy.m_new2.call(this);
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/sprites/enemy_turret.monkey<12>";
	pop_err();
	return this;
}
c_EnemyTurret.prototype.p_InitAI=function(){
	push_err();
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/sprites/enemy_turret.monkey<40>";
	dbg_object(this).m_ai=(c_EnemyTurretAI.m_new.call(new c_EnemyTurretAI,(this)));
	pop_err();
}
c_EnemyTurret.prototype.p_Create=function(){
	push_err();
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/sprites/enemy_turret.monkey<21>";
	dbg_object(this).m_animated_sprite=c_AnimatedSprite.m_new.call(new c_AnimatedSprite,"enemies.png",c_Vec2.m_new.call(new c_Vec2,0.0,0.0),9.0,9.0,5,0.0);
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/sprites/enemy_turret.monkey<22>";
	dbg_object(this).m_animated_sprite.p_AddSequence("4097",[0]);
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/sprites/enemy_turret.monkey<23>";
	dbg_object(this).m_animated_sprite.p_AddSequence("4098",[1]);
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/sprites/enemy_turret.monkey<24>";
	dbg_object(this).m_animated_sprite.p_AddSequence("4099",[2]);
	...
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/sprites/enemy_turret.monkey<26>";
	dbg_object(this).m_animated_sprite.p_AddSequence("4101",[4]);
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/sprites/enemy_turret.monkey<28>";
	dbg_object(this).m_animated_sprite.p_PlaySequence(dbg_object(this).m_type,100,true);
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/sprites/enemy_turret.monkey<31>";
	c_CollisionEngine.m_Instance2().p_AddStaticBody(this);
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/sprites/enemy_turret.monkey<34>";
	dbg_object(this).m_cannon=c_EnemyCannon.m_new.call(new c_EnemyCannon);
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/sprites/enemy_turret.monkey<36>";
	this.p_InitAI();
	pop_err();
}
...
c_TileMapCollider.m_new=function(t_tile_layer){
	push_err();
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/components/tile_map_collider.monkey<12>";
	c_CollisionEngine.m_new.call(this);
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/components/tile_map_collider.monkey<13>";
	c_CollisionEngine.m_Instance2().p_RegisterDelegate(this);
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/components/tile_map_collider.monkey<15>";
	dbg_object(this).m_tile_layer=t_tile_layer;
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/components/tile_map_collider.monkey<16>";
...
c_TileMapCollider.m_new2=function(){
	push_err();
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/components/tile_map_collider.monkey<6>";
	c_CollisionEngine.m_new.call(this);
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/components/tile_map_collider.monkey<6>";
	pop_err();
	return this;
...
c_TileMapCollider.prototype.p_Update=function(){
	...
	while(t_.p_HasNext()){
		...
		var t_cx=t_o.p_GetBox().p_CenterX();
		err_info="/Users/ricardo/git_loadingplay/gbjam4/src/components/tile_map_collider.monkey<22>";
		var t_cy=t_o.p_GetBox().p_CenterY();
		err_info="/Users/ricardo/git_loadingplay/gbjam4/src/components/tile_map_collider.monkey<23>";
		var t_tx=Math.floor(t_cx/dbg_object(dbg_object(this.m_tile_layer).m_parent).m_tileWidth);
		err_info="/Users/ricardo/git_loadingplay/gbjam4/src/components/tile_map_collider.monkey<24>";
		var t_ty=Math.floor(t_cy/dbg_object(dbg_object(this.m_tile_layer).m_parent).m_tileHeight);
		err_info="/Users/ricardo/git_loadingplay/gbjam4/src/components/tile_map_collider.monkey<25>";
		var t_index=t_tx+(dbg_object(this.m_tile_layer).m_width)*t_ty;
		err_info="/Users/ricardo/git_loadingplay/gbjam4/src/components/tile_map_collider.monkey<26>";
		var t_tile=0;
		err_info="/Users/ricardo/git_loadingplay/gbjam4/src/components/tile_map_collider.monkey<28>";
		if(t_index<(dbg_object(dbg_object(this).m_tile_layer).m_data.length-1)){
			err_info="/Users/ricardo/git_loadingplay/gbjam4/src/components/tile_map_collider.monkey<29>";
			t_tile=dbg_array(dbg_object(dbg_object(this).m_tile_layer).m_data,((t_index)|0))[dbg_index];
		}
		err_info="/Users/ricardo/git_loadingplay/gbjam4/src/components/tile_map_collider.monkey<32>";
		if(t_tile!=0){
...
function c_EnemyTurretAI(){
	c_EnemyAI.call(this);
	this.implments={c_iDrawable:1};
}
c_EnemyTurretAI.prototype=extend_class(c_EnemyAI);
c_EnemyTurretAI.m_new=function(t_parent){
	push_err();
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/sprites/enemy_turret.monkey<7>";
	c_EnemyAI.m_new.call(this,t_parent);
	pop_err();
	return this;
}
c_EnemyTurretAI.m_new2=function(){
	push_err();
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/sprites/enemy_turret.monkey<5>";
	c_EnemyAI.m_new2.call(this);
	err_info="/Users/ricardo/git_loadingplay/gbjam4/src/sprites/enemy_turret.monkey<5>";
	pop_err();
	return this;
